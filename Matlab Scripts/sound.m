...
plot(freqs);
title({'G9: Virtual Frequency Generator Partial Waveform';'Date: 09-04-2019, Time: 17:37 - 19:37, Audio request code: A6413'});
...
sgtitle({'G10: Partial Waveforms';'Date: 09-04-2019, Time: 17:37 - 19:37, Audio request code: A6413'})
...
histfit(Dif_dpcm);
title({'G11: DPCM Distribution Differences';'Date: 09-04-2019, Time: 17:37 - 19:37, Audio request code: A6413'});
F = getframe(f3);
imwrite(F.cdata, 'Plots/G11.png', 'png');

f4 = figure('Position', get(0, 'Screensize'));
histfit(Sdpcm);
title({'G12: DPCM Distribution Values';'Date: 09-04-2019, Time: 17:37 - 19:37, Audio request code: A6413'});
F = getframe(f4);
...
histfit(Dif_aq);
title({'G13: AQ-DPCM Distribution Differences';'Date: 09-04-2019, Time: 17:37 - 19:37, Audio request code: A6413'});
F = getframe(f5);
imwrite(F.cdata, 'Plots/G13.png', 'png');

f6 = figure('Position', get(0, 'Screensize'));
histfit(Saq);
title({'G14: AQ-DPCM Distribution Values';'Date: 09-04-2019, Time: 17:37 - 19:37, Audio request code: A6413'});
F = getframe(f6);
...
plot(mean);
title({'G15: Samples Mean Values of Audio Clip 1';'Date: 09-04-2019, Time: 17:37 - 19:37, Audio request code: A6413'});
F = getframe(f7);
...
plot(step);
title({'G16: Samples Step Values of Audio Clip 1';'Date: 09-04-2019, Time: 17:37 - 19:37, Audio request code: A6413'});
F = getframe(f8);
...
plot(mean);
title({'G17: Samples Mean Values of Audio Clip 2';'Date: 09-04-2019, Time: 17:37 - 19:37, Audio request code: A6413'});
F = getframe(f9);
...
plot(step);
title({'G18: Samples Step Values of Audio Clip 2';'Date: 09-04-2019, Time: 17:37 - 19:37, Audio request code: A6413'});
F = getframe(f10);
